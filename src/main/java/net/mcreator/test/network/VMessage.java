...
import net.mcreator.test.procedures.VToucheEnfonceeProcedure;
...
public class VMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			VToucheEnfonceeProcedure.execute(world, x, y, z);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		TestMod.addNetworkMessage(VMessage.class, VMessage::buffer, VMessage::new, VMessage::handler);
	}
}
