...
public class TestEntity extends TamableAnimal {
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("enderfish");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(TestEntity.this.getId());
					return new EnderfishMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TestEntity retval = TestModEntities.TEST.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.AMETHYST_SHARD, Items.CHORUS_FRUIT).contains(stack.getItem());
	}
