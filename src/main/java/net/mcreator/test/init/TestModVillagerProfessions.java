...
public class TestModVillagerProfessions {
	private static final Map<String, ProfessionPoiType> POI_TYPES = new HashMap<>();
	public static final DeferredRegister<VillagerProfession> PROFESSIONS = DeferredRegister.create(ForgeRegistries.VILLAGER_PROFESSIONS, TestMod.MODID);
	public static final RegistryObject<VillagerProfession> CHAMANV = registerProfession("chamanv", () -> Blocks.SOUL_CAMPFIRE, () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.soul_sand.place")));
	...
	private static RegistryObject<VillagerProfession> registerProfession(String name, Supplier<Block> block, Supplier<SoundEvent> soundEvent) {
		...
		return PROFESSIONS.register(name, () -> {
			...
			return new VillagerProfession(TestMod.MODID + ":" + name, poiPredicate, poiPredicate, ImmutableSet.of(), ImmutableSet.of(), soundEvent.get());
		});
	}
